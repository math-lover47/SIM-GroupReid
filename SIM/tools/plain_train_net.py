...
from methods.SIM.fastreid.engine import default_argument_parser, default_setup

sys.path.append('.')

from methods.SIM.fastreid.config import get_cfg
from methods.SIM.fastreid.data import build_reid_test_loader, build_reid_train_loader
from methods.SIM.fastreid.evaluation.testing import flatten_results_dict
from fastreid.engine import launch
from methods.SIM.fastreid.modeling import build_model
from methods.SIM.fastreid.solver import build_lr_scheduler, build_optimizer
from methods.SIM.fastreid.evaluation import inference_on_dataset, print_csv_format, ReidEvaluator
from methods.SIM.fastreid.utils.checkpoint import Checkpointer, PeriodicCheckpointer
from methods.SIM.fastreid.utils import comm
from methods.SIM.fastreid.utils.events import (
    CommonMetricPrinter,
    EventStorage,
    JSONWriter,
    TensorboardXWriter
