...
from methods.SIM.fastreid.data.build import _root
from methods.SIM.fastreid.data.data_utils import read_image
from methods.SIM.fastreid.data.datasets import DATASET_REGISTRY
import logging

from methods.SIM.fastreid.data.transforms import ToTensor
