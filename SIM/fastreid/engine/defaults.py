...
from methods.SIM.fastreid.evaluation import (ReidEvaluator,
...
from methods.SIM.fastreid.utils.collect_env import collect_env_info
from methods.SIM.fastreid.utils.env import seed_all_rng
from methods.SIM.fastreid.utils.events import CommonMetricPrinter, JSONWriter, TensorboardXWriter
...
class DefaultTrainer(TrainerBase):
    ...
    #     super().before_epoch()
    #     # Set current epoch for feature saving
    #     if hasattr(self.model, 'backbone') and hasattr(self.model.backbone, 'g_vit'):
    #         self.model.backbone.g_vit.set_epoch(self.epoch)
